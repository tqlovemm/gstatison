...
@interface ThirteenWithVideoView()
<
 UITableViewDelegate,
...
@implementation ThirteenWithVideoView
                     ...
                     parameters:paras
                       ...
                       complete:^(id result) {
                           ...
                           if (result != nil) {
                               ...
                               //                               if (_pageIndex == 1 && articleArr.count > 0) { // 缓存数据
                               //                                   [self saveCacheDatas];
                               //                               }
                           ...
                           if (self.seekFrameArray.count == 0)
                               _errorView = [_errorView addErrorViewWithType:error_nodata_flag];
                           //                           if (_pageIndex == 1) [self getCacheDatas];
