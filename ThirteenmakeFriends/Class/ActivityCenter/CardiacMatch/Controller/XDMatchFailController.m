...
@interface XDMatchFailController ()<XDMatchFailViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate>
...
@implementation XDMatchFailController
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:XDMatchResultFailedNotification object:@2];
}
...
- (void)xdd_setupSubViews {
    ...
    XDMatchFailView *matchView = [[XDMatchFailView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 382)];
    XD_WeakSelf
...
#pragma mark - XDMatchFailViewDelegate
