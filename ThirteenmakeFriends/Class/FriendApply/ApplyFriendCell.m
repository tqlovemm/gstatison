...
//        [_addButton setBackgroundColor:[UIColor colorWithRed:10 / 255.0 green:82 / 255.0 blue:104 / 255.0 alpha:1.0]];
        [_addButton setBackgroundColor:RGB(97, 60, 187)];
...
//        [_refuseButton setBackgroundColor:[UIColor colorWithRed:87 / 255.0 green:186 / 255.0 blue:205 / 255.0 alpha:1.0]];
        [_refuseButton setBackgroundColor:RGB(210, 210, 210)];
        ...
        _refuseButton.layer.cornerRadius = 15;
        _refuseButton.layer.masksToBounds = YES;
        
        _dealLabel = [[UILabel alloc] init];
        _dealLabel.backgroundColor = [UIColor clearColor];
        _dealLabel.textColor = [UIColor blackColor];
        _dealLabel.font = [UIFont boldSystemFontOfSize:15.0];
...
-(void)layoutSubviews
{
    ...
    // 申请与通知
    _dealLabel.frame = CGRectMake(self.contentView.frame.size.width - 60, (self.contentView.frame.size.height - 30) / 2, 50, 30);
