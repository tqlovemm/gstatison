...
- (void)setupPlusButton
{
    ...
    if ([User_Sex isEqualToString:@"1"]) {
        [plusButton setBackgroundImage:[UIImage imageNamed:@"pluswoman"] forState:UIControlStateNormal];
        [plusButton setBackgroundImage:[UIImage imageNamed:@"pluswomanHL"] forState:UIControlStateHighlighted];
    } else {
        [plusButton setBackgroundImage:[UIImage imageNamed:@"plusman"] forState:UIControlStateNormal];
        [plusButton setBackgroundImage:[UIImage imageNamed:@"plusmanHL"] forState:UIControlStateHighlighted];
    }
...
//    self.plusButton.size = CGSizeMake(self.width / (self.items.count + 1), 49);
