...
@interface XDSeekScreenController ()<UITableViewDelegate,UITableViewDataSource,STPickerSingleDelegate>
/** tableView */
...
@implementation XDSeekScreenController
