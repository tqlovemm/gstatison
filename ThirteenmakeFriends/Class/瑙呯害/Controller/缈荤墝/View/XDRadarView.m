...
//        pulsingLayer.backgroundColor = self.raderColor.CGColor;//圈圈背景颜色，不设置则为透明。
//        pulsingLayer.borderColor = self.raderColor.CGColor;//RGB(210, 229, 251)
