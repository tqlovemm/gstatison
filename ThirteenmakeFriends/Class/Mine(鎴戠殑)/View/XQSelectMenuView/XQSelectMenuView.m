...
//    flowLayout1.minimumInteritemSpacing = 5;
    ...
    mainVc.minimumInteritemSpacing = flowLayout1.minimumInteritemSpacing;
    
    accessoryVc.minimumLineSpacing = flowLayout2.minimumLineSpacing;
    accessoryVc.minimumInteritemSpacing = flowLayout2.minimumInteritemSpacing;
    
    mainVc.delegate = self;
    accessoryVc.delegate = self;
    
    mainVc.labelColor = self.labelColor;
    accessoryVc.labelColor = self.labelColor;
...
- (void)layoutSubviews{
    ...
    self.accessoryVc.view.frame = CGRectMake(0, CGRectGetMaxY(self.accessoryTitleLabel.frame)+viewMargin, self.frame.size.width,self.accessoryVc.viewHeight);
}
