...
//    NSLog(@"--%lf---%d---%lf",self.view.frame.size.width,itemWidth,self.minimumInteritemSpacing);
    
    self.viewHeight = 10 + self.dataSourceArray.count/lineCount * (itemHeight + self.minimumLineSpacing);
//    self.viewHeight = self.dataSourceArray.count/lineCount * (itemHeight + self.minimumLineSpacing);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    item.labelColor = self.labelColor;
