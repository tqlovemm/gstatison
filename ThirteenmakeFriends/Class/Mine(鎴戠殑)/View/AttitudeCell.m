...
- (void)attentionClicked {
    ...
    if ([self.delegate respondsToSelector:@selector(attitudeCell:ClickedBtnWithAttitudeAndFansFrame:)]) {
        [self.delegate attitudeCell:self ClickedBtnWithAttitudeAndFansFrame:self.attitudeFrame];
    }
}
