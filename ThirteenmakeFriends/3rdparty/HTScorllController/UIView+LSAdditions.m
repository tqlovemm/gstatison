...
- (void)resetLandscapeCoordinateWithRate:(CGFloat)rate
{
    self.frame = CGRectMake(self.left * rate, self.top, self.width * rate, self.height);
}

- (void)resetLeftCorrdinateWithRate:(CGFloat)rate
{
    self.frame = CGRectMake(self.left * rate, self.top, self.width, self.height);
}
@end
