...
- (instancetype)initWithFrame:(CGRect)frame minValue:(CGFloat)minValue maxValue:(CGFloat)maxValue blockSpaceValue:(CGFloat)blockSpaceValue{
    return [self initWithFrame:frame image:[UIImage imageNamed:@"huadong-1"] minValue:minValue maxValue:maxValue blockSpaceValue:blockSpaceValue];
}

- (instancetype)initWithFrame:(CGRect)frame{
    return [self initWithFrame:frame image:[UIImage imageNamed:@"huadong-1"] minValue:2.f maxValue:90.f blockSpaceValue:1.f];
}
